        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kundenname = table.Column<string>(maxLength: 30, nullable: true),
                    Verfuegbar = table.Column<bool>(nullable: false),
                    AusgeliehenUM = table.Column<DateTime>(nullable: false),
                    AusgeliehenBIS = table.Column<DateTime>(nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
                    Anhängerkupplung = table.Column<bool>(nullable: true),
                    Ladevolumen = table.Column<decimal>(nullable: true),
                    SeitenWagen = table.Column<bool>(nullable: true)
                },
                constraints: table =>
                {
